...
class FireworksApp(arcade.Window):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text(start_y=350, start_x=220, text='FELIZ ANO NOVO', font_size=35,font_name='Kaiti', color=arcade.color.RED)
        arcade.draw_text(font_name=('MingLiU-ExtB'), font_size=35, start_x=350, start_y=300, color=arcade.color.RED, text='2020')
